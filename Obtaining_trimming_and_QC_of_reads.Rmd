...
The reads appear to be trimmed for cm21. However, just in case I will run trimmomatic. It would be useful to incoprate trimming into the pipeline if additional strains are used. As trimmomatic in Sharcnet is used quite often, I added addition commands and code to view the progress of the script. 
